<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
    <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
        <article
            ...
            @if(!is_null($post->first_paragraph))
                <p>{{ $post->first_paragraph }}</p>
            @endif
            @if(!is_null($post->second_paragraph))
                <p>{{ $post->second_paragraph }}</p>
            @endif
            @if(!is_null($post->third_paragraph))
        ...
        <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            @foreach($relatedPosts as $relatedPost)
                <article class="max-w-xs">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-400">{{ $relatedPost->summary }}</p>
                    <a href="#"
            ...
            <form action="#">
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        <label for="email"
                               class="hidden mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Email address</label>
                ...
                <div
                    class="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300">We care about the protection of your data.
                    <a href="#"
